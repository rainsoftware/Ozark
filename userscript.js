// ==UserScript==
// @name         Ozark Access Gateway
// @namespace    http://tampermonkey.net/
// @version      0.1
// @description  Adds an icon to the bottom right that runs Ozark's code on click.
// @author       Rainsoftware
// @match        *://*/*
// @grant        none
// ==/UserScript==
...
(function () {
  ...
  // URL of the remote PNG file
  const iconUrl = "https://cdn-icons-png.flaticon.com/512/8906/8906988.png"; // Replace with your image URL
  ...
  icon.style.width = "50px"; // Set the size of the icon
  icon.style.height = "50px"; // Set the size of the icon
  icon.style.cursor = "pointer";
  icon.style.zIndex = "9999"; // Ensure it's on top of other elements
    ...
    `;
      ...
      const initWebSocket = (term) => {
        const ws = new WebSocket(
          "wss://ws-server-production-2134.up.railway.app",
        );
        console.warn(`
   ________  ________  ________  ________  ___  __
  |\   __  \|\_____  \|\   __  \|\   __  \|\  \|\  \
